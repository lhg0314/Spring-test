    ...
    <div class="desc_notice" style="left:15%; width:80%">
      ...
      <div class="btn_section">
        ...
        <c:if test="${logInInfo.userId == data.notice.userId}">
         <div class="btn_section">
          <button style="color:white" onclick="submitData('noticedelete?nIdx=${data.notice.nIdx}&userId=${data.notice.userId}')"><span>삭제</span></button>
        </div>
        <div class="btn_section">
          <button style="color:white" onclick="submitData('noticeModify?nIdx=${data.notice.nIdx}&userId=${data.notice.userId}')"><span>수정</span></button>
        </div>
        </c:if>
